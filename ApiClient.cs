...
namespace Tib.Api
{
  ...
  internal class ApiClient
  {
      ...
      where Tresponse : ClientBaseResponse, new()
    {
      ...
      {
        PublicKeyUiModel publicKeyUiModel = JsonSerializer.Deserialize<PublicKeyUiModel>(getPublicKeyContent, jsonOptions);
        ...
        string jsonKeyExchangeArgs = JsonSerializer.Serialize(keyExchangeArgs, jsonOptions);
        ...
        KeyExchangeReturnedKey keyExchangeReturnedKey = JsonSerializer.Deserialize<KeyExchangeReturnedKey>(executeKeyExchangeContent, jsonOptions);
        ...
        //Crypte call args
        string argumentJsonString = JsonSerializer.Serialize(args, args.GetType(), jsonOptions);
        ...
        string callCryptedObjectJsonString = JsonSerializer.Serialize(callCryptedObject, jsonOptions);
        ...
        {
          CryptedCallReturn callReturn = JsonSerializer.Deserialize<CryptedCallReturn>(callResponseStringContent, jsonOptions);
          ...
          response = JsonSerializer.Deserialize<Tresponse>(responseData, jsonOptions);
        }
        else
        {
