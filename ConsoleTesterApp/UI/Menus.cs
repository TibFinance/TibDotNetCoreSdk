...
namespace ConsoleTesterApp.UI
{
/// <summary>
///  Class Responsible for the Display of theMenus in the Console  App
/// </summary>
  public class Menus
  {
    /// <summary>
    /// the first MEnu that Appears in the console App.
    /// </summary>
