...
For details See the pdf [Documentation](https://tibfinance.github.io/). Or get the Pdf Verion [Here](https://github.com/TibFinance/TibDotNetCoreSdk/blob/main/Documentation/Tib%20Api%20Documentation.pdf).
